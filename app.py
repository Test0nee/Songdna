...
# --- 5. AUDIO ENGINE (FIXED FOR MODERN LIBROSA) ---
...
def extract_audio_features(file_path):
    ...
    # --- TEMPO FIX (Handle Array vs Scalar) ---
    try:
    ...
    # --- PEAK PICK FIX (Keyword Arguments) ---
    # Newer Librosa versions require named arguments here
    try:
